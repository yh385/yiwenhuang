#####################################################################
# CS 3410 PA6/7: Dynamic Memory Allocator (i.e., malloc)            #
#                                                                   #
...
.PHONY: heaplib.o debug print-debug lame lame-debug lame-print-debug
...
# the dependencies.  For example, in the test_correctness target $+ expands
# to: heaplib.o test_correctness.c
test_correctness: heaplib.o test_correctness.c
...
help:
	...
	@printf "\nAll targets compile the test_correctness executable. You\n"
	...
	@printf "      These targets should not be compiled (e.g. test_correctness). Use the\n"
...
# one executable (say test_correctness), then you would just do something like
...
# .PHONY: all test
#
# all: test_correctness
#
# test_correctness: heaplib.o heaplib.h test_correctness.c
#     gcc $(CFLAGS) $+ -o $@ $(LD_FLAGS)
#
