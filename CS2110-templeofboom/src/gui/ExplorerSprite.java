 ...
 * screen. Handles functions to update the explorer and update its drawing as well.
 */
public class ExplorerSprite extends JPanel{
     ...
     * @param startCol the player's starting column
     */
    public ExplorerSprite(int startRow, int startCol) {
        ...
        //Create a thread which will periodically update the explorer's animation
    ...
    /** Return the image representing the current state of the explorer. * @return image of the current explorer to draw to the screen
     */
    ...
    /* Tell the explorer to move from its current location to node dst.
